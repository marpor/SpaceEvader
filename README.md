...
The goal of the game is to get the highest score by destroying as many enemies as possible.
...
You can slow down the gameplay if you stop moving, which lets you plan your next shots carefully.
...
Made in GarageBand by my son Tim.

#### Sounds

All of the sounds are either:
 - Recorded and manipulated by myself and my son Leo.
 - Generated using the excellent [rFXGen](https://raylibtech.itch.io/rfxgen).

## License

The source code in this project is distributed under the [MIT License](LICENSE_source_code.txt).
...
The licensing is split as follows:

1. Source code is distributed under the [MIT License](LICENSE_source_code.txt).
2. Game assets are distributed under [CC BY NC SA](https://creativecommons.org/licenses/by-nc-sa/2.0/) as documented in [LICENSE_assets.txt](LICENSE_assets.txt).
